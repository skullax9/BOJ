...
<ul>
<li><p>예제 1번의 <code>my_string</code>의 'm'을 "rn"으로 바꾸는 과정을 표로 나타내면 다음과 같습니다.</p>
<table class="table">
        <thead><tr>
<th>my_string</th>
<th>m</th>
...
<ul>
<li><p>예제 2번의 <code>my_string</code>의 'm'을 "rn"으로 바꾸는 과정을 표로 나타내면 다음과 같습니다.</p>
<table class="table">
        <thead><tr>
<th>my_string</th>
<th>p</th>
...
<ul>
<li>예제 3번의 <code>my_string</code>에는 'm'이 없습니다. 따라서 <code>my_string</code> 그대로인 "jerry"를 return 합니다.</li>
</ul>

<p>입출력 예 #4</p>

<ul>
<li>예제 4번의 <code>my_string</code>에는 'm'이 없습니다. 따라서 <code>my_string</code> 그대로인 "burn"를 return 합니다.</li>
</ul>
